...
{-| Helper that allow you to get the mouse position from a current draggable object.
-}
getPosition : Draggable dropMeta dragMeta -> Maybe MousePosition
getPosition (Draggable d) =
    d |> Maybe.map .position
